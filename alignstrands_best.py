#!/usr/bin/env python3
#
# Investigate how well we can expect to predict metastructure. 
# We do this by looking at all candidate structures, and choosing
# the structure closest to the true structure. 
#
...
if __name__=='__main__':
    ...
    parser.add_argument('truemotifs',
                        help='Directory containing true motifs')
    ...
    main(args.pid, args.seqdir, args.bonddir, args.learningf, args.truemotifs,
